...
public class CourseService {
	...
	public void enrollStudent(String studentId, String courseId) { // TODO implement so it adds the given course form																	
		Student student = students.get(studentId);					// the student
